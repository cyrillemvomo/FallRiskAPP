List<List<dynamic>> general_info = [[], [], [], [], [], [], [], [], []];
List<List<dynamic>> clinical_quest = [[], [], [], [], [], [], [], [], []];
...
List<List<dynamic>> best_2 = [[], []]; // in reality best 3
List<List<dynamic>> best_5 = [[], []]; // in reality best 6
List<List<dynamic>> fes = [[], [], [], [], [], [], []];
// List<dynamic> fes_s = [];
List<List<dynamic>> collected_data = [
  [],
  [],
  [],
  [],
